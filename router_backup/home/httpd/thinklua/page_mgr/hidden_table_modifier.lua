...
local fptHiddenTableMgr = require("page_mgr.hidden_table_mgr")
local modulesPath = "../../webmodules/modules/"
fptHiddenTableMgr:addModifier(function ()
if env.getenv("CountryCode") == "2008" then
fptHiddenTableMgr:addItem(
{
basicType="view",
urlPath="tr069",
fileName=modulesPath.."fpt_tr069_remotemgr_t.lp",
needLogin=true,
right=1,
}
)
...
basicType="data",
urlPath="tr069_data",
fileName=modulesPath.."fpt_tr069_remotemgr_lua.lua",
needLogin=true,
right=1,
}
)
